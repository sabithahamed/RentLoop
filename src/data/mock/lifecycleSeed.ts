...
export function buildLifecycleSeed(
  ...
  // Mock listings mirror the shape of the real ones, minus photos — the mock
  // has no storage to serve them from. Discovery against Supabase has the real
  // set with photographs.
  const listings: Listing[] = [
    {
      id: id("lst"),
      title: "Annex with separate entrance",
      description:
        "Two-bedroom annex on a quiet lane with its own gate and entrance. Water and electricity separately metered.",
      city: "Nugegoda",
      addressLine: "Off Sarana Road",
      rentCents: 48_000_00,
      depositCents: 96_000_00,
      bedrooms: 2,
      bathrooms: 1,
      propertyType: "annex",
      furnished: "semi",
    ...
    },
    {
      ...
      description: "Fully furnished upper floor with a private staircase.",
      city: "Dehiwala",
      addressLine: "Hill Street",
      rentCents: 55_000_00,
      depositCents: 110_000_00,
      bedrooms: 2,
      bathrooms: 2,
    ...
    },
    {
      ...
      description: "Single room in a family home. Meals can be arranged.",
      city: "Ratmalana",
      addressLine: "Station Road",
      rentCents: 22_000_00,
      depositCents: 22_000_00,
      bedrooms: 1,
      bathrooms: 1,
    ...
    },
    {
      ...
      description: "Detached three-bedroom house with a small garden and parking.",
      city: "Kotte",
      addressLine: "Pagoda Road",
      rentCents: 95_000_00,
      depositCents: 190_000_00,
      bedrooms: 3,
      bathrooms: 2,
      propertyType: "house",
